...
function Player:initialize(map, world, x,y, camera, lightworld)
...
function Player:filter(other)
  ...
  if kind == 'Guardian' or kind == "Enemy" or kind == 'Block' or (kind == 'Platform' and other:canPass(self.l,self.t,self.w,self.h)) then return 'slide' end
end
